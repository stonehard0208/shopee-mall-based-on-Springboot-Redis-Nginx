...
<head>
    ...
    <title>shopee.com 虾皮网 全球网购中心</title>
</head>
<body>
<nav>
        ...
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 SHOPEE 商品/品牌/店铺"
                           maxlength="50">
    ...
    <div class="home_nav">
        ...
        <a href="http://vip.tmall.com/" target="_blank">SHOPEE会员</a>
...
<%--        <a href="https://suning.tmall.com/" target="_blank">苏宁易购</a>--%>
        <div class="home_nav_title" style="margin-left:446px;margin-top:0px">
            <img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/header_nav_title.png">
            <span>畅销商品</span>
        </div>
    </div>
...
<div class="banner_main">
    ...
    <ul class="banner_nav" style="margin-left:992px;margin-top:-500px;">
            <c:forEach items="${requestScope.hotProductIdSet}" var="product_id" varStatus="xh">
                <li data-toggle="" data-status="">
                    <img src="${pageContext.request.contextPath}/res/images/hotProductIcon/${xh.index}.jpg">
                    <a href="${pageContext.request.contextPath}/product/${product_id}" style="z-index:999">${requestScope.hotProductName[xh.index]}</a>
                </li>
            </c:forEach>
        </ul>
    <a href="#"></a>
