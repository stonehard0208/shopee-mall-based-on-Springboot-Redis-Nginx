...
<head>
    ...
    <title>${requestScope.product.product_name}-shopee.com虾皮</title>
</head>
<body>
<nav>
        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 虾皮 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜虾皮" class="searchTmall">
                </div>
    ...
    <div class="loginDiv">
        ...
        <div class="qrcodeLogin">
            ...
            <div class="qrcodeFooter">
                ...
                <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机虾皮</a>
            </div>
            <div class="loginLinks">
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送虾皮积分<span><fmt:formatNumber type="number"
                ...
                <c:forEach items="${requestScope.loveProductList}" var="product">
                    <li class="context_ul_main">
                        <div class="context_ul_img">
                            <a href="/shopee/product/${product.product_id}">
