...
//     * @param value
//     */
//    public int zGet(String key,Object value){
//        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
//        return (zset.score(key,value).intValue());
//    }
     ...
     * @param value
     */
    public Double zIncr(String key,Object value,int num){
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        return zset.incrementScore(key,value,num);
    }
